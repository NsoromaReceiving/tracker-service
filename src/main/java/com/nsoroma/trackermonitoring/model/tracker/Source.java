...
public class Source {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", id).append("deviceId", deviceId).append("model", model).append("blocked", blocked).append("tariffId", tariffId).append("phone", phone).append("statusListingId", statusListingId).append("creationDate", creationDate).append("tariffEndDate", tariffEndDate).toString();
    }
